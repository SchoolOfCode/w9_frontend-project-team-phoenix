        ...
        <div className="footer-container">
            <div className="footer">
                <div className="social">
                    <SocialMediaIconsReact className="icons" borderColor="#F87F25" icon="twitter" iconColor="rgba(255,255,255,1)" backgroundColor="transparent" url="https://twitter.com/theSchoolOfCode" size="38" />
                    <SocialMediaIconsReact className="icons" borderColor="#F87F25" icon="facebook" iconColor="rgba(255,255,255,1)" backgroundColor="transparent" url="https://www.facebook.com/schoolofcode/" size="38" />
